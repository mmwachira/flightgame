...
namespace DoozyUI
{
    ...
    public class UINotification : MonoBehaviour
    {
        ...
        void RegisterToUIManager()
        {
            ...
            notificationContainer.RegisterUIElement();
            if(overlay != null) { overlay.RegisterUIElement(); }
            ...
            if(len > 0)
            {
                for(int i = 0; i < len; i++)
                {
                    if(specialElements[i] != null) { specialElements[i].RegisterUIElement(); }
        ...
        void UnregisterFromUIManager()
        {
            ...
            notificationContainer.UnregisterUIElement();
            if(overlay != null) { overlay.UnregisterUIElement(); }
            ...
            if(len > 0)
            {
                ...
                {
                    if(specialElements[i] == null) { continue; }
                    specialElements[i].UnregisterUIElement();
                }
            }
