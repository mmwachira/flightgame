...
#pragma warning restore 0414
        ...
        protected override void SerializedObjectFindProperties()
        {
            ...
            onPointerEnterNavigation = serializedObject.FindProperty("onPointerEnterNavigation");
            #endregion
            #region PointerExit
        ...
        protected override void InitAnimBools()
        {
            ...
            showOnPointerEnter = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnPointerEnter.boolValue : false, Repaint);
            showOnPointerEnterEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnPointerEnter.GetPersistentEventCount() > 0 : false, Repaint);
            showOnPointerEnterGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onPointerEnterGameEvents.arraySize > 0 : false, Repaint);
            showOnPointerEnterNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onPointerEnterNavigation.hide.Count > 0 || uiButton.onPointerEnterNavigation.show.Count > 0 : false, Repaint);

            showOnPointerExit = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnPointerExit.boolValue : false, Repaint);
            showOnPointerExitEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnPointerExit.GetPersistentEventCount() > 0 : false, Repaint);
            showOnPointerExitGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onPointerExitGameEvents.arraySize > 0 : false, Repaint);
            showOnPointerExitNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onPointerExitNavigation.hide.Count > 0 || uiButton.onPointerExitNavigation.show.Count > 0 : false, Repaint);

            showOnPointerDown = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnPointerDown.boolValue : false, Repaint);
            showOnPointerDownEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnPointerDown.GetPersistentEventCount() > 0 : false, Repaint);
            showOnPointerDownGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onPointerDownGameEvents.arraySize > 0 : false, Repaint);
            showOnPointerDownNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onPointerDownNavigation.hide.Count > 0 || uiButton.onPointerDownNavigation.show.Count > 0 : false, Repaint);

            showOnPointerUp = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnPointerUp.boolValue : false, Repaint);
            showOnPointerUpEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnPointerUp.GetPersistentEventCount() > 0 : false, Repaint);
            showOnPointerUpGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onPointerUpGameEvents.arraySize > 0 : false, Repaint);
            showOnPointerUpNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onPointerUpNavigation.hide.Count > 0 || uiButton.onPointerUpNavigation.show.Count > 0 : false, Repaint);
            ...
            showOnClickNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onClickNavigation.hide.Count > 0 || uiButton.onClickNavigation.show.Count > 0 : false, Repaint);

            showOnDoubleClick = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnDoubleClick.boolValue : false, Repaint);
            showOnDoubleClickEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnDoubleClick.GetPersistentEventCount() > 0 : false, Repaint);
            showOnDoubleClickGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onDoubleClickGameEvents.arraySize > 0 : false, Repaint);
            showOnDoubleClickNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onDoubleClickNavigation.hide.Count > 0 || uiButton.onDoubleClickNavigation.show.Count > 0 : false, Repaint);

            showOnLongClick = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnLongClick.boolValue : false, Repaint);
            showOnLongClickEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.OnLongClick.GetPersistentEventCount() > 0 : false, Repaint);
            showOnLongClickGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? onLongClickGameEvents.arraySize > 0 : false, Repaint);
            showOnLongClickNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.onLongClickNavigation.hide.Count > 0 || uiButton.onLongClickNavigation.show.Count > 0 : false, Repaint);
            ...
            showSelectedAnimation = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? uiButton.selectedLoop.Enabled || loadSelectedLoopPresetAtRuntime.boolValue : false, Repaint);
        ...
        protected override void OnEnable()
        {
            ...
            currentCategoryNameIsCustomName = buttonCategory.stringValue.Equals(DUI.CUSTOM_NAME); //note that the previous category name is Custom; we need this in order to ask the dev if he wants to add a new Button name to a newly selected category
        }
            ...
            QUI.BeginHorizontal(width);
            {
                ...
                else
                {
                    ...
                    if(QUI.EndChangeCheck())
                    {
                        ...
                        {
                            buttonNameIndex = -1;
                            currentCategoryNameIsCustomName = true; //note that the previous category name is Custom; we need this in order to ask the dev if he wants to add a new Button name to a newly selected category
                        }
                        serializedObject.ApplyModifiedProperties();
                    }
                }
            ...
            QUI.BeginHorizontal(width);
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            LockEditor();
                            if((EditorSettings.askToAddButtonNameToCategoryIfNotFound || currentCategoryNameIsCustomName) &&
                        ...
                        currentCategoryNameIsCustomName = false; //note that the previous category name is not Custom; we need this in order to ask the dev if he wants to add a new Button name to a newly selected category
                    }
                }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnPointerEnter, uiButton.onPointerEnterNavigation, onPointerEnterEditorNavigationData, showOnPointerEnterNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnPointerExit, uiButton.onPointerExitNavigation, onPointerExitEditorNavigationData, showOnPointerExitNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnPointerDown, uiButton.onPointerDownNavigation, onPointerDownEditorNavigationData, showOnPointerDownNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnPointerUp, uiButton.onPointerUpNavigation, onPointerUpEditorNavigationData, showOnPointerUpNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnClick, uiButton.onClickNavigation, onClickEditorNavigationData, showOnClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnDoubleClick, uiButton.onDoubleClickNavigation, onDoubleClickEditorNavigationData, showOnDoubleClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIButton, DUIUtils.ButtonEventType.OnLongClick, uiButton.onLongClickNavigation, onLongClickEditorNavigationData, showOnLongClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
