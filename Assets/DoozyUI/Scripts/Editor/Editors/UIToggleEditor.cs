...
#pragma warning restore 0414
        ...
        protected override void InitAnimBools()
        {
            ...
            showOnPointerEnterEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                    ? uiToggle.OnPointerEnterToggleOn.GetPersistentEventCount() > 0 ||
                                                      uiToggle.OnPointerEnterToggleOff.GetPersistentEventCount() > 0
                                                    : false, Repaint);
            showOnPointerEnterGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                        ? onPointerEnterGameEventsToggleOn.arraySize > 0 ||
                                                          onPointerEnterGameEventsToggleOff.arraySize > 0
                                                        : false, Repaint);
            showOnPointerEnterNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                        ? uiToggle.onPointerEnterNavigationToggleOn.hide.Count > 0 ||
                                                          uiToggle.onPointerEnterNavigationToggleOn.show.Count > 0 ||
                                                          uiToggle.onPointerEnterNavigationToggleOff.hide.Count > 0 ||
                                                          uiToggle.onPointerEnterNavigationToggleOff.show.Count > 0
                                                        : false, Repaint);
            ...
            showOnPointerExitEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                   ? uiToggle.OnPointerExitToggleOn.GetPersistentEventCount() > 0 ||
                                                     uiToggle.OnPointerExitToggleOff.GetPersistentEventCount() > 0
                                                   : false, Repaint);
            showOnPointerExitGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                       ? onPointerExitGameEventsToggleOn.arraySize > 0 ||
                                                         onPointerExitGameEventsToggleOff.arraySize > 0
                                                       : false, Repaint);
            showOnPointerExitNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                       ? uiToggle.onPointerExitNavigationToggleOn.hide.Count > 0 ||
                                                         uiToggle.onPointerExitNavigationToggleOn.show.Count > 0 ||
                                                         uiToggle.onPointerExitNavigationToggleOff.hide.Count > 0 ||
                                                         uiToggle.onPointerExitNavigationToggleOff.show.Count > 0
                                                       : false, Repaint);

            showOnClick = new AnimBool(EditorSettings.autoExpandEnabledFeatures ? useOnClick.boolValue : false, Repaint);
            ...
            showOnClickEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                             ? uiToggle.OnClickToggleOn.GetPersistentEventCount() > 0 ||
                                               uiToggle.OnClickToggleOff.GetPersistentEventCount() > 0
                                             : false, Repaint);
            showOnClickGameEvents = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                 ? onClickGameEventsToggleOn.arraySize > 0 ||
                                                   onClickGameEventsToggleOff.arraySize > 0
                                                 : false, Repaint);
            showOnClickNavigation = new AnimBool(EditorSettings.autoExpandEnabledFeatures
                                                 ? uiToggle.onClickNavigationToggleOn.hide.Count > 0 ||
                                                   uiToggle.onClickNavigationToggleOn.show.Count > 0 ||
                                                   uiToggle.onClickNavigationToggleOff.hide.Count > 0 ||
                                                   uiToggle.onClickNavigationToggleOff.show.Count > 0
                                                 : false, Repaint);
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOn, DUIUtils.ButtonEventType.OnPointerEnter, uiToggle.onPointerEnterNavigationToggleOn, onPointerEnterEditorNavigationDataToggleOn, showOnPointerEnterNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOff, DUIUtils.ButtonEventType.OnPointerEnter, uiToggle.onPointerEnterNavigationToggleOff, onPointerEnterEditorNavigationDataToggleOff, showOnPointerEnterNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOn, DUIUtils.ButtonEventType.OnPointerExit, uiToggle.onPointerExitNavigationToggleOn, onPointerExitEditorNavigationDataToggleOn, showOnPointerExitNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOff, DUIUtils.ButtonEventType.OnPointerExit, uiToggle.onPointerExitNavigationToggleOff, onPointerExitEditorNavigationDataToggleOff, showOnPointerExitNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOn, DUIUtils.ButtonEventType.OnClick, uiToggle.onClickNavigationToggleOn, onClickEditorNavigationDataToggleOn, showOnClickNavigation, UpdateAllNavigationData, true, false, width, MiniBarHeight);
        }
        ...
        {
            DUIUtils.DrawNavigation(this, DUIUtils.DUIComponent.UIToggleOff, DUIUtils.ButtonEventType.OnClick, uiToggle.onClickNavigationToggleOff, onClickEditorNavigationDataToggleOff, showOnClickNavigation, UpdateAllNavigationData, true, false, width, MiniBarHeight);
        }
